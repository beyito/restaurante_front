          ...
          {isAuthenticated ? (
            <div className='hidden md:flex items-center gap-3'>
              ...
              <div className='flex flex-col'>
                <Link
                  to='/perfil'
                  className='grid font-medium text-sm transition-transform duration-300 bg-transparent hover:bg-gray-300 hover:scale-105 rounded px-2 py-1'
                >
                  ...
                  {isAuthenticated ? (
                    <div className='flex items-center gap-5'>
                      ...
                      <div className='flex flex-col gap-9'>
                        <Link
                          to='/perfil'
                          className='grid text-base font-medium transition-transform duration-300 bg-transparent hover:bg-gray-300 hover:scale-105 rounded px-2 py-1'
                          onClick={() => setIsMenuOpen(false)}
                        >
